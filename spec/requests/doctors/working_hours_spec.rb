...
RSpec.describe "Doctors::WorkingHours", type: :request do
  describe "GET /doctors/:doctor_id/working_hours" do
    ...
    it "returns list of working_hours" do
      get "/doctors/#{doctor.id}/working_hours", params: {}, headers: {"Content-Type" => "application/json"}
  ...
  describe "POST /doctors/:doctor_id/working_hours" do
    ...
    context "when success" do
      it "returns created working_hours" do
        post "/doctors/#{doctor.id}/working_hours", params: { working_hours: working_hour_attr }.to_json, headers: {"Content-Type" => "application/json"}
    ...
    context "when failed" do
      it "returns error" do
        post "/doctors/#{doctor.id}/working_hours", params: { working_hours: { wday: nil } }.to_json, headers: {"Content-Type" => "application/json"}
  ...
  describe "PUT /doctors/:doctor_id/working_hours" do
    ...
    context "when success" do
      it "returns updated working_hours" do
        put "/doctors/#{doctor.id}/working_hours/#{working_hour.id}", params: { working_hours: { wday: 3 } }.to_json, headers: {"Content-Type" => "application/json"}
    ...
    context "when failed" do
      it "returns error" do
        put "/doctors/#{doctor.id}/working_hours/#{working_hour.id}", params: { working_hours: { wday: '' } }.to_json, headers: {"Content-Type" => "application/json"}
  ...
  describe "DELETE /doctors/:doctor_id/working_hours" do
    ...
    context "when success" do
      it "destroys working_hours" do
        delete "/doctors/#{doctor.id}/working_hours/#{working_hour.id}", params: {}.to_json, headers: {"Content-Type" => "application/json"}
